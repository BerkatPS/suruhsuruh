...
import { siteConfig, themeConfig } from '@/config/site';

const Footer = () => {
    const currentYear = new Date().getFullYear();

    return (
        <footer className="bg-dark-bg border-t border-dark-border text-dark-text">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <p className="text-dark-textSecondary mb-6 max-w-md">
                            Layanan jasa terpercaya untuk membantu Anda menyelesaikan tugas akademik dan perbaikan elektronik dengan hasil berkualitas.
                        </p>
                        <div className="flex space-x-4 mb-6">
                            <a
                                ...
                                className="text-dark-textSecondary hover:text-primary transition-colors"
                                aria-label="Twitter"
                            >
                    ...
                    {/* Navigation Columns */}
                    {themeConfig.footerNav.map((section, i) => (
                        <div key={i}>
                            <h3 className="text-lg font-semibold mb-4 text-dark-text">{section.section}</h3>
