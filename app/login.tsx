                        ...
                        <div className="bg-dark-card rounded-xl shadow-lg p-8 border border-dark-border">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="flex items-center">
                                    ...
                                    />
                                    <label htmlFor="rememberMe" className="ml-2 block text-sm text-dark-textSecondary">
                                        Ingat saya
                                    </label>
                                </div>
                            ...
                            <div className="mt-8 pt-6 border-t border-dark-border">
                                ...
                                <div className="flex gap-4 mt-6">
                                    <button
                                        type="button"
                                        className="flex-1 flex items-center justify-center gap-2 px-4 py-2 border border-dark-border bg-dark-bg rounded-lg text-dark-text hover:bg-dark-border/50 transition-colors"
                                    >
